...
public class UIAddPlayer extends AppCompatActivity {
   ...
   // DBHelper sdpdb;
    ...
    public void OnRegisterClick(View view)
    {
        ...
        if(bfirstName && blastName && buserName)
        {
            ...
            //pvp7:To integrate the class structure change
            boolean result = Admin.addPlayer(this,strFirstName,strLastName,strUserName);
            //
            if(!result)
            {
