...
public class ExternalWebService {
	 ...
	 */
	{
		...
		//players	
		players.put("player1", new PlayerRating("John", "Doe", 2, 3, 5));
		players.put("player2", new PlayerRating("James", "Bond", 1, 2, 4));
		players.put("player3", new PlayerRating("George", "Burdell", 3, 4, 2));
		players.put("player4", new PlayerRating("Nancy", "Drew", 2, 2, 0));
	}
	...
	//inner class, used to make it easier to input/output lists of player activity_user_rating
	...
	/**
	 * Get the list of all player activity_user_rating, unordered
	 * @return list of player activity_user_rating (PlayerRating contains String firstname, String lastname, int solved, int started, int incorrect)
	 */
	public List<PlayerRating> syncRatingService(){
		return new ArrayList<PlayerRating>(players.values());		
	}

	public PlayerRating requestPlayerRating(String username) {
		if (players.containsKey(username))
			return players.get(username);
		return new PlayerRating("","",0,0,0);
	}
	 ...
	 * @return true if successfully updated or added player rating, false if any values are null or empty or cannot add to player activity_user_rating
	 */
